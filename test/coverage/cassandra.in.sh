...
# Code coverage requires using the Cobertura instrumented classes over
# the regular classes, so put that as the first classpath:
CLASSPATH=$CASSANDRA_HOME/build/cobertura/classes:$CLASSPATH
